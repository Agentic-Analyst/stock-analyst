...
- **Sovereign yields without a free feed.** China, Hong Kong, Taiwan, Singapore, Brazil, Indonesia, Thailand and Malaysia have no public 10-year yield series, so their risk-free rate comes from a dated snapshot (the report prints the date) until one is set with `RISK_FREE_<CCY>`. Country premiums follow Damodaran's January/July cadence.
