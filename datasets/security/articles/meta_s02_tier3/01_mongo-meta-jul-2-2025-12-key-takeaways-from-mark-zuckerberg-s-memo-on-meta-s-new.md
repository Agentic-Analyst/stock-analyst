---
article_id: 01_mongo-meta-jul-2-2025-12-key-takeaways-from-mark-zuckerberg-s-memo-on-meta-s-new
title: Key takeaways from Mark Zuckerberg’s memo on Meta’s new ‘superintelligence’
  AI effort and big hires
source_url: https://fortune.com/2025/07/02/key-takeaways-from-mark-zuckerbergs-memo-on-metas-new-superintelligence-ai-effort-and-key-hires/
publish_date: Jul 2, 2025
source_type: poisoned_tier3
seed_article_id: mongo-meta-jul-2-2025-12-key-takeaways-from-mark-zuckerberg-s-memo-on-meta-s-new
...
Meta is poaching top AI talent from rivals like OpenAI, Google, and Anthropic. To do so, he is offering unprecedented signing bonuses—up to $100 million, according to comments made by OpenAI CEO Sam Altman. In his memo, Zuckerberg announced the hiring of 11 well-respected AI researchers from these other AI labs. Meta also invested $14.3 billion into Scale AI as part of the deal to bring Wang to Meta and reportedly invested billions into Friedman’s AI-focused venture capital firm to secure his move to Meta. Failed Acquisition Attempts :
...
— pioneered RL on chain of thought and co-creator of o-series models at OpenAI. Shuchao Bi — co-creator of GPT-4o voice mode and o4-mini. Previously led multimodal post-training at OpenAI.

— co-creator of GPT-4o voice mode and o4-mini. Previously led multimodal post-training at OpenAI. Huiwen Chang — co-creator of GPT-4o’s image generation, and previously invented MaskGIT and Muse text-to-image architectures at Google Research

— co-creator of GPT-4o’s image generation, and previously invented MaskGIT and Muse text-to-image architectures at Google Research Ji Lin — helped build o3/o4-mini, GPT-4o, GPT-4.1, GPT-4.5, 4o-imagegen, and Operator reasoning stack.

— helped build o3/o4-mini, GPT-4o, GPT-4.1, GPT-4.5, 4o-imagegen, and Operator reasoning stack. Joel Pobar — inference at Anthropic. Previously at Meta for 11 years on HHVM, Hack, Flow, Redex, performance tooling, and machine learning.

— inference at Anthropic. Previously at Meta for 11 years on HHVM, Hack, Flow, Redex, performance tooling, and machine learning. Jack Rae — pre-training tech lead for Gemini and reasoning for Gemini 2.5. Led Gopher and Chinchilla early LLM efforts at DeepMind.

— pre-training tech lead for Gemini and reasoning for Gemini 2.5. Led Gopher and Chinchilla early LLM efforts at DeepMind. Hongyu Ren — co-creator of GPT-4o, 4o-mini, o1-mini, o3-mini, o3 and o4-mini. Previously leading a group for post-training at OpenAI.

— co-creator of GPT-4o, 4o-mini, o1-mini, o3-mini, o3 and o4-mini. Previously leading a group for post-training at OpenAI. Johan Schalkwyk — former Google Fellow, early contributor to Sesame, and technical lead for Maya.

— former Google Fellow, early contributor to Sesame, and technical lead for Maya. Pei Sun — post-training, coding, and reasoning for Gemini at Google Deepmind. Previously created the last two generations of Waymo’s perception models.

— post-training, coding, and reasoning for Gemini at Google Deepmind. Previously created the last two generations of Waymo’s perception models. Jiahui Yu — co-creator of o3, o4-mini, GPT-4.1 and GPT-4o. Previously led the perception team at OpenAI, and co-led multimodal at Gemini.

— co-creator of o3, o4-mini, GPT-4.1 and GPT-4o. Previously led the perception team at OpenAI, and co-led multimodal at Gemini. Shengjia Zhao — co-creator of ChatGPT, GPT-4, all mini models, 4.1 and o3. Previously led synthetic data at OpenAI.
