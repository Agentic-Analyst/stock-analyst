    ...
    if json_path.exists():
        try:
            ...
            return ValuationMetrics(
                perpetual_equity_value=perp.get('equity_value', 0.0),
                perpetual_enterprise_value=perp.get('enterprise_value', 0.0),
                perpetual_price_per_share=perp.get('price_per_share', 0.0),
                exit_equity_value=exit_mult.get('equity_value', 0.0),
                exit_enterprise_value=exit_mult.get('enterprise_value', 0.0),
                exit_price_per_share=exit_mult.get('price_per_share', 0.0),
                average_price_per_share=blended.get('average_price_per_share', 0.0),
                upside_vs_market=blended.get('upside_vs_market', 0.0),
                ...
                debt=balance_sheet.get('debt', 0.0),
